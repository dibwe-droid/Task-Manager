...
- [x] `POST /api/tasks` returns 400 for invalid data
- [x] `GET /api/tasks/:id` returns task or 404
- [x] `GET /api/tasks` returns array of tasks
- [x] `PUT /api/tasks/:id` updates task or returns 404
- [x] `DELETE /api/tasks/:id` deletes task or returns 404
- [x] All endpoints return consistent JSON format
- [x] Test coverage >80% for task endpoints
